            ...
            <Card style={containerStyle}>
                <View style={{padding:20, height:265, alignItems:'center'}}>
                    <View style={cardSectionStyle}>
                        ...
                        <Text style={styles.popupTitle}>Delete Alert</Text>
                        <View style={{paddingTop:20, paddingLeft:20, paddingRight:20}}>
                            <Text>
                                Are you sure you want to delete GR?
                            </Text>
                        </View>
                        <View style={{borderTopWidth:1, marginTop:20,backgroundColor:'#ccc', borderTopColor:'#cccccc', flexDirection:'row',width:'100%', alignItems:'center', justifyContent:'space-between', borderBottomLeftRadius:5, borderBottomRightRadius:5, height:50}}>
                            <Button style={{width:'49.75%',alignItems:'center',borderRadius:0,borderBottomLeftRadius:6, justifyContent:'center',backgroundColor:'#ffffff', height:50}} transparent onPress={onAccept}><Text style={{textAlign:'center', color:'#444', fontSize:16}}>YES</Text></Button>
                            <Button style={{width:'49.75%',borderLeftColor:'#cccccc',borderRadius:0, borderBottomRightRadius:6,borderLeftWidth:5,alignItems:'center', justifyContent:'center', color:'#444',backgroundColor:'#ffffff', height:50}}  transparent onPress={onDecline}><Text style={{textAlign:'center', color:'#444', fontSize:16}}>NO</Text></Button>
                        </View>
                    </View>
                </View>
            </Card>
